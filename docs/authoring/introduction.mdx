...
> [!TIP]
>
> `nav` only orders pages. To order the folders themselves — and to split the sidebar into
> labelled groups — use the [`nav_order`](/github-actions/introduction) workflow input.
